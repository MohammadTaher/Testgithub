...
public class ExcelUtils {
	 ...
	 * @throws IOException
	 */
	public static void readExcelTestCase(String xlFilePath, String sheetName) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void readExcelTestStep(String xlFilePath, String sheetName) throws IOException {
		File xlPath = new File(xlFilePath);
		FileInputStream xlStream = new FileInputStream(xlPath);
		@SuppressWarnings("resource")
		HSSFWorkbook wb = new HSSFWorkbook(xlStream);
	 ...
	 * @throws IOException
	 */
	public static void writeTestStepResult(String xlFilePath, String xlData[][], String sheetName) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void writeTestCaseResult(String xlFilePath, String xlData[][], String sheetName) throws IOException {
		File file = new File(xlFilePath); 
		HSSFWorkbook wb = new HSSFWorkbook();
		HSSFSheet xlSheet = wb.createSheet(sheetName);// Create Sheet Name
